...
function UsageGuide() {
  const topics = [
    ...
    { number: '07', title: 'Caixinhas', text: 'Crie reservas com meta opcional e registre aportes. Em cada aporte, escolha se ele deve contar como saida e reduzir o saldo mensal ou apenas atualizar o valor reservado.' },
